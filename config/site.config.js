...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'tevinsemil@outlook.com',
  ...
  protectedRoutes: ['/私密', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'hantaiwen29@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Tevin0727',
    },
  ],
